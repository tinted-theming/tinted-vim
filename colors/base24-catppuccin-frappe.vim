...
if !has('gui_running')
  if exists('g:tinted_shell_path')
    execute 'silent !/bin/sh '.g:tinted_shell_path.'/base24/catppuccin-frappe.sh'
  endif
endif
...
let s:gui10        = '292c3c'
let g:tinted_gui10 = '292c3c'
let s:gui11        = '232634'
let g:tinted_gui11 = '232634'
let s:gui12        = 'ea999c'
let g:tinted_gui12 = 'ea999c'
let s:gui13        = 'f2d5cf'
let g:tinted_gui13 = 'f2d5cf'
let s:gui14        = 'a6d189'
let g:tinted_gui14 = 'a6d189'
let s:gui15        = '99d1db'
let g:tinted_gui15 = '99d1db'
let s:gui16        = '85c1dc'
let g:tinted_gui16 = '85c1dc'
let s:gui17        = 'f4b8e4'
let g:tinted_gui17 = 'f4b8e4'

" Terminal color definitions
let s:cterm00        = '00'
let g:tinted_cterm00 = '00'
let s:cterm03        = '09'
let g:tinted_cterm03 = '09'
let s:cterm05        = '07'
let g:tinted_cterm05 = '07'
let s:cterm07        = '15'
let g:tinted_cterm07 = '15'
let s:cterm08        = '01'
let g:tinted_cterm08 = '01'
let s:cterm0A        = '03'
let g:tinted_cterm0A = '03'
let s:cterm0B        = '02'
let g:tinted_cterm0B = '02'
let s:cterm0C        = '06'
let g:tinted_cterm0C = '06'
let s:cterm0D        = '04'
let g:tinted_cterm0D = '04'
let s:cterm0E        = '05'
let g:tinted_cterm0E = '05'
...
if has('nvim')
  let g:terminal_color_0  = '#303446'
  let g:terminal_color_1  = '#e78284'
  let g:terminal_color_2  = '#a6d189'
  let g:terminal_color_3  = '#e5c890'
  let g:terminal_color_4  = '#8caaee'
  let g:terminal_color_5  = '#ca9ee6'
  let g:terminal_color_6  = '#81c8be'
  let g:terminal_color_7  = '#c6d0f5'
  let g:terminal_color_8  = '#51576d'
  let g:terminal_color_9  = '#ea999c'
  let g:terminal_color_10 = '#a6d189'
  let g:terminal_color_11 = '#f2d5cf'
  let g:terminal_color_12 = '#85c1dc'
  let g:terminal_color_13 = '#f4b8e4'
  let g:terminal_color_14 = '#99d1db'
  let g:terminal_color_15 = '#babbf1'
...
call <sid>hi('CursorColumn',  '', s:gui01, '', s:cterm01, 'none', 'none')
call <sid>hi('CursorLine',    '', s:gui01, '', s:cterm01, 'none', 'none')
...
call <sid>hi('MatchParen',     '', '', '', '',  'inverse', 'underline')
...
call <sid>hi('Statement',      s:gui17, '', s:cterm17, '', 'none', '')
...
call <sid>hi('Keyword',        s:gui17, '', s:cterm17, '', 'none', '')
...
call <sid>hi('SpecialComment', s:gui0A, '', s:cterm0A, '', 'none', '')
...
call <sid>hi('Added',          s:gui14, s:guibg, s:cterm14, s:ctermbg, 'italic', '')
call <sid>hi('Changed',        s:gui05, s:guibg, s:cterm05, s:ctermbg, 'italic', '')
call <sid>hi('Removed',        s:gui12, s:guibg, s:cterm12, s:ctermbg, 'italic', '')
...
if has('nvim-0.8.0')
  ...
  call <sid>hi('@variable.parameter',         s:gui04, '', s:cterm04, '', 'none', '')
  call <sid>hi('@variable.parameter.builtin', s:gui04, '', s:cterm04, '', 'italic', '')
  ...
  hi! link @string.special.path Directory
  call <sid>hi('@string.special.url',         s:gui09, '', s:cterm09, '', 'italic', '')
  ...
  call <sid>hi('@function.builtin',           s:gui0D, '', s:cterm0D, '', 'italic', '')
  call <sid>hi('@function.call',              s:gui16, '', s:cterm16, '', '', '')
  hi! link @function.macro Macro

  call <sid>hi('@function.method',            s:gui0D, '', s:cterm0D, '', '', '')
  call <sid>hi('@function.method.call',       s:gui16, '', s:cterm16, '', '', '')
  ...
  hi! link @lsp.type.punctuation @punctuation.delimiter
  ...
  hi! link @lsp.type.formatSpecifier.rust @string.special
  hi! link @lsp.type.function.rust @lsp
  hi! link @lsp.type.keyword.rust @lsp
  hi! link @lsp.type.method.rust @lsp
  hi! link @lsp.type.selfKeyword.rust @variable.builtin
  hi! link @lsp.typemod.builtinType.injected.rust @type.builtin
  hi! link @lsp.typemod.function.injected.rust @lsp.type.function
  hi! link @lsp.typemod.interface.injected.rust @lsp.type.interface
  hi! link @lsp.typemod.keyword.injected.rust @lsp.type.keyword
  hi! link @lsp.typemod.lifetime.injected.rust @attribute
  hi! link @lsp.typemod.method.injected.rust @lsp.type.method

  " LUA
  hi! link @lsp.typemod.keyword.documentation.lua @tag
  hi! link @lsp.type.property.lua @lsp
  hi! link @lsp.type.method.lua @lsp
  hi! link @lsp.typemod.method.injected.lua @lsp.type.method
...
call <sid>hi('DiagnosticDeprecated',     '', '', '', '', 'strikethrough', '')
...
" Gitsigns
call <sid>hi('GitSignsDeleteVirtLn',       s:gui12, s:gui01, s:cterm12, s:cterm01, '', '')
call <sid>hi('GitSignsDeleteVirtLnInLine', s:gui01, s:gui12, s:cterm12, s:cterm01, '', '')
call <sid>hi('GitSignsDeleteInline',       s:gui01, s:gui12, s:cterm01, s:cterm12, '', '')
call <sid>hi('GitSignsAddInline',       s:gui14, s:gui12, s:cterm14, s:cterm12, '', '')
...
call <sid>hi('NeogitDiffContextHighlight', s:gui03, '', s:cterm03, '', 'italic', '')
