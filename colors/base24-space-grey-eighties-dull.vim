...
" Scheme name: Space Grey Eighties Dull
...
if !has('gui_running')
  if exists('g:tinted_shell_path')
    execute 'silent !/bin/sh '.g:tinted_shell_path.'/base24/space-grey-eighties-dull.sh'
  endif
endif
...
" Theme setup
let g:colors_name = 'base24-space-grey-eighties-dull'
